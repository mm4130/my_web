<?php
define('API_KEY','303405704:AAEV14acgYay-uN77FGuxQ-GOhELL0tlB9o');
//----######------
...
SendMessage($chat_id,"شما بايد در كانال ما عضو و سپس دستورا را اجرا نماييد.
@pmr_creator");
}
...
elseif(isset($update->callback_query)){
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'text'=>"🔰ربات شما با موفقیت حذف شد !❌ Robot has ben deleted!🔰",
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید🔰 - Pleas join to channel🔰",'url'=>"https://telegram.me/pmr_creator"]
                    ]
                ]
            ])
        ])
...
[our channel〽️](https://telegram.me/pmr_creator)
[start your bot〽️](https://telegram.me/$un)",
		...
		save("bots/$un/data/pmsend_txt.txt","Message was Sent!");
...
if ($from_id == $admin) {
$text = str_replace("/total","",$textmessage);
...
$botname = file_get_contents("data/$from_id/bots.txt");
if ($botname == "") {
SendMessage($chat_id,"You still have not robots!✴️");
return;
}
 	var_dump(makereq('sendMessage',[
	'chat_id'=>$update->message->chat->id,
	...
	'inline_keyboard'=>[
	[
	['text'=>"✴️ @".$botname,'url'=>"https://telegram.me/".$botname]
	]
	]
	])
	]));
...
[Robot's channel〽️](https://telegram.me/pmr_creator)",
  'parse_mode'=>'MarkDown',
         'reply_markup'=>json_encode([
             'keyboard'=>[
                [
...
[كانال روبات〽️](https://telegram.me/pmr_creator)",
  'parse_mode'=>'MarkDown',
         'reply_markup'=>json_encode([
             'keyboard'=>[
                [
